...
namespace BossEngine
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TODO: Temporary Keyboard mapping. ImGui will use those indices to peek into the io.KeysDown[] array.
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(BE_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
